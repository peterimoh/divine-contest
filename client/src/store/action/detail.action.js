...
export const uploadDpAction = (id, formData) => (dispatch) => {
  ...
  axios
    .post(`${apiUrl}/api/auth/upload/${id}`, formData)
    .then((res) => {
...
export const updatePaypalAction = (id, formData) => (dispatch) => {
  ...
  axios
    .post(`${apiUrl}/api/auth/paypal/${id}`, formData)
    .then((res) => {
...
export const updatePasswordAction = (id, formData) => (dispatch) => {
  ...
  axios
    .post(`${apiUrl}/api/auth/update-password/${id}`, formData)
    .then((res) => {
